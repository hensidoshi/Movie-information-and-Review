...
class WatchlistController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.watchlists.create', compact('users', 'movies', 'reviews'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.watchlists.index')->with('success', 'Watchlist added successfully.');
    }
    ...
    public function edit(Watchlist $watchlist)
    {
        ...
        return view('admin.watchlists.edit', compact('watchlist', 'users', 'movies', 'reviews'));
    }
    ...
    {
        return view('admin.watchlists.view', compact('watchlist'));
    }
}
