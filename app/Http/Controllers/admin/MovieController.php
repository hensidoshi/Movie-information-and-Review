...
class MovieController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.movies.create', compact('genres', 'directors', 'actors', 'languages'));
    }
    ...
    public function edit(Movie $movie)
    {
        ...
        return view('admin.movies.edit', compact('movie', 'genres', 'directors', 'actors', 'languages'));
    }
    ...
    public function showById(Request $request)
    {
        ...
        if (!$id) {
            return redirect()->route('admin.movies.index')->with('error', 'Please enter a Movie ID.');
        }
