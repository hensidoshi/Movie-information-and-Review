...
<div class="container mt-5">
    ...
    @else
        ...
        <div class="details-card" style="display: flex; flex-direction: row; align-items: flex-start; gap: 30px;">
            ...
            <div style="flex-grow: 1;">
                <h3 class="text-info" style="margin-top: 0; margin-bottom: 15px;">{{ $movie->name }}</h3>
                
                <div class="details-item">
                    <span class="details-label">Genre:</span> {{ $movie->genres->pluck('name')->implode(', ') ?? 'N/A' }}
                </div>
                <div class="details-item">
                    <span class="details-label">Director:</span> {{ $movie->director->name ?? 'N/A' }}
                </div>
                <div class="details-item">
                    <span class="details-label">Actor:</span> {{ $movie->actors->pluck('name')->implode(', ') ?? 'N/A' }}
                </div>
                <div class="details-item">
                    <span class="details-label">Duration:</span> {{ $movie->duration }} min
                </div>
                <div class="details-item">
                ...
                <div class="details-card" style="margin-top: 10px;">
                    <div class="d-flex gap-3 align-items-center">
                        ...
                        @endif
                        <a href="{{ url('/') }}" class="btn btn-outline-light">Back</a>
                    </div>
                </div>
            </div>
        </div>
