...
<div class="container mt-4">
    <h2 class="mb-4">Edit Director</h2>

    <form action="{{ route('directors.update', $director->id) }}" method="POST" enctype="multipart/form-data" novalidate>
        @csrf
        @method('PUT')
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('directors.index') }}" class="btn btn-secondary">Back</a>
        </div>
    </form>
</div>
