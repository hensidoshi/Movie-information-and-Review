        ...
        <div class="col-xl-3 col-lg-6">
            <div class="card custom-card main-card-item primary">
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.movies.index') }}" class="text-white-50 text-decoration-underline fw-medium fs-13">View all movies</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6">
            <div class="card custom-card main-card-item info">
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.users.index') }}" class="text-white-50 text-decoration-underline fw-medium fs-13">View all users</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6">
            <div class="card custom-card main-card-item success">
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.reviews.index') }}" class="text-white-50 text-decoration-underline fw-medium fs-13">View all reviews</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6">
            <div class="card custom-card main-card-item warning">
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.watchlists.index') }}" class="text-white-50 text-decoration-underline fw-medium fs-13">View all watchlist</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-4">
            ...
            <div class="card custom-card">
                <div class="card-header justify-content-between">
                    ...
                    <a href="{{ route('admin.movies.index') }}" class="text-white-50 text-decoration-underline fw-medium fs-13">View All</a>
                </div>
                                ...
                                <div class="flex-fill">
                                    ...
                                    <div class="mt-1">
                                        @forelse ($movie->genres as $genre)
                                            <span class="badge bg-secondary-transparent fs-10 fw-normal">{{ $genre->name }}</span>
                                        @empty
                                            <span class="badge bg-secondary-transparent fs-10 fw-normal">N/A</span>
                                        @endforelse
                                    </div>
        ...
        <div class="col-xl-4">
            ...
            <div class="card custom-card">
                <div class="card-header justify-content-between">
                    ...
                    <a href="{{ route('admin.reviews.index') }}" class="text-white-50 text-decoration-underline fw-medium fs-11">View All</a>
                </div>
                <div class="card-body p-0">
                    <ul class="list-group list-group-flush">
        ...
        <div class="col-xl-4">
            ...
            <div class="card custom-card">
                <div class="card-header justify-content-between">
                    ...
                    <a href="{{ route('admin.users.index') }}" class="text-white-50 text-decoration-underline fw-medium fs-11">View All</a>
                </div>
                <div class="card-body p-0">
                    <ul class="list-group list-group-flush">
