...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="{{ route('admin.movies.create') }}" class="btn btn-add">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions-cell">
                        <a href="{{ route('admin.movies.show', $movie->id) }}" class="btn btn-sm btn-outline-info me-1">
                            <i class="bi bi-eye"></i> View
                        </a>
                        <a href="{{ route('admin.movies.edit', $movie->id) }}" class="btn btn-sm btn-edit me-1">
